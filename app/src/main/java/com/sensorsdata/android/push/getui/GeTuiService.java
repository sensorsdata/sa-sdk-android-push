...
public class GeTuiService extends GTIntentService {
    ...
    public void onReceiveServicePid(Context context, int i) {
        SFLogger.d(TAG, "onReceiveServicePid:" + i);
    }

    @Override
    public void onReceiveClientId(Context context, String clientId) {
        SFLogger.d(TAG, "onReceiveClientId:" + clientId);
        /*
         ...
         * 将收到的信息发送到页面显示，测试使用
         */
        SFUtils.sendBroadcast(context, SFConstant.PUSH_TYPE_GETUI,"ClientId = " + clientId);
    }
    ...
    public void onReceiveMessageData(Context context, GTTransmitMessage gtTransmitMessage) {
         ...
         * 将收到的信息发送到页面显示，测试使用
         */
        SFUtils.sendBroadcast(context, SFConstant.PUSH_TYPE_GETUI, sfData);
    }

    @Override
    public void onReceiveOnlineState(Context context, boolean b) {
        SFLogger.d(TAG, "onReceiveOnlineState:" + b);
    }

    @Override
    public void onReceiveCommandResult(Context context, GTCmdMessage gtCmdMessage) {
        SFLogger.d(TAG, "onReceiveCommandResult:"
    ...
    public void onNotificationMessageClicked(Context context, GTNotificationMessage gtNotificationMessage) {
        SFLogger.d(TAG, "onNotificationMessageClicked:"
                + "\nmessageId = " + gtNotificationMessage.getMessageId()
                + "\ntaskId = " + gtNotificationMessage.getTaskId()
                + "\ncontent = " + gtNotificationMessage.getContent()
                + "\ntitle = " + gtNotificationMessage.getTitle());
