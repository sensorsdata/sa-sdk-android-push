    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                 ...
                 * 将收到的信息发送到页面显示，测试使用
                 */
                SFUtils.sendBroadcast(context, SFConstant.PUSH_TYPE_JPUSH, "registerId = " + regId);
                ...
                if (connected) {
                     ...
                     * 将收到的信息发送到页面显示，测试使用
                     */
                    SFUtils.sendBroadcast(context, SFConstant.PUSH_TYPE_JPUSH, "registerId = " + JPushInterface.getRegistrationID(context));
                }
            } else {
